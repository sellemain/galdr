...
METRICS: tuple[MetricVocabulary, ...] = (
    ...
    MetricVocabulary(
        ...
        "motor entrainment, motor pull, bodily coupling, groove arrives, pulse offered but not seized",
    ...
    MetricVocabulary(
        ...
        "Local motor entrainment and pattern reduced by pressure and accent phase drift.",
        ...
        "body can settle, groove seat, nervous bracing, resisted motor capture, comfort withheld",
    ...
    MetricVocabulary(
        ...
        "Local motor-capture score before comfort penalties.",
    ...
    MetricVocabulary(
        ...
        "Local pattern, attention, motor entrainment, and low accent drift.",
    ...
    MetricVocabulary(
        ...
        "Harmonic mass, dynamic pressure, sparse density, and drag without motor capture.",
