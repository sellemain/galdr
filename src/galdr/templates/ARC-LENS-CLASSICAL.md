...
Write a listening experience for classical, instrumental, or large-form music. Follow the work as long-form attention over time. Do not force verse/chorus/hook/lyric-persona logic onto the piece.

The governing question is: **what must the listener remember for the form to become audible?** Before drafting, build a private memory map:

- principal material: the gesture, motif, sonority, rhythm, text, or ensemble state the listener must recognize later
- contrast: what interrupts, answers, opposes, or reframes it
- development: what is fragmented, extended, transferred, reharmonized, compressed, enlarged, or withheld
- transformed recurrence: what returns, which audible features identify it, and exactly how prior events make it different now
- destination: the cadence, arrival, suspension, withdrawal, exhaustion, or unresolved ending toward which the form moves
...
Do not write another default arc with orchestral nouns. If the page could be relabeled as a general listening experience without losing its argument, strengthen the memory, agency, and transformed-return logic or choose a different lens.

Let the prose breathe at the scale of the piece. Shape: usually 5 to 8 paragraphs, no headings. For a 3–6 minute work, roughly 450–750 words is usually enough. Longer forms may earn about 90–125 words per minute up to roughly 1,200 words when memory, agency, and transformed returns genuinely require it; stable miniatures may be shorter.
