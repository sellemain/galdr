...
Treat dramatic transition language as an evidence claim, not as color. Words such as *crashes*, *slams*, *explodes*, *erupts*, *bursts*, *drops out*, *vanishes*, *full band*, and *full weight* require both an abrupt audible boundary and a large local contrast with the immediately preceding passage. Name only the sources the ear can verify; a general swell or thicker texture does not prove that drums, bass, or the full ensemble entered. If the boundary is blended, the contrast is modest, or the source is uncertain, use the plainer truth: enters, returns, gathers, thins, eases, or continues. This is a proof threshold, not a ban: when the abrupt boundary, large contrast, and named source are all clear, keep the forceful word if it is the most accurate local description. Do not flatten a genuine rupture merely because a neutral verb is available.
...
- voice or vocal delivery
- rhythm, pulse, groove, or repetition
- harmony, register, brightness, or melodic contour
- density, pressure, texture, silence, or re-entry
