...
```bash
galdr assemble <track-name> [--template arc|arc-family|first|none] [--lens default|sound|structure|meaning|lyrics-study|classical|ritual] [--mode blind|lyrics|context|full]
```
